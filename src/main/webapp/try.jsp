...
<body>
	...
	<div id="DataForm" style="display: none;">
		...
		<div class="container">
			...
			<form>
				...
				<br> 
				<label for="note">About</label>
				<br>
				<input type="text" id="note" name="note">
				
				<h1>Enter all your links</h1>
				
				<input  type='text' placeholder='enter your link'  >
				
				<div id="innerdiv" ></div>
				
				<div  onclick="addMoreComponent()" style="cursor: pointer; background: gray; border-radius: 4px solid black "   >add one more link</div>
			</form>
	...
	<script type="text/javascript" src="js/jvascript.js"></script>
